...
* Add the originating error that caused a client reset to occur to the client reset tracking metadata storage. ([PR #7542](https://github.com/realm/realm-core/pull/7542))
