...
struct realm_user : realm::c_api::WrapC, std::shared_ptr<realm::app::User> {
    realm_user(std::shared_ptr<realm::app::User> user)
        : std::shared_ptr<realm::app::User>{std::move(user)}
    {
    }
